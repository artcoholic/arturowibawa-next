...
const Zapped = ({ id }) => {
  return (
    <Provider apiKey="pt_24f41aec661cfe264e7a4a77bcb0de">
      <LikeButton namespace="thoughts" id={id} hideCounterIfLessThan={1}>
        {({
          handlePress,
          totalLikes,
          userLiked,
          ...
          <Wrapper>
            {isCounterVisible && (
              <Text css={{ color: "$fg_inverseSecondary" }}>{totalLikes}</Text>
            )}
            <Button
              onClick={handlePress}
              disabled={isLoading}
              liked={userLiked}
            >
              <Tooltip>{userLiked ? "Unzap" : "Zap!"}</Tooltip>
              <svg
                id="thunder-svg"
                viewBox="0 0 60 60"
              ...
              >
                <g id="Group" fill="none" fillRule="evenodd">
                  <path
                    d="M15.4095 2.60279C15.9308 1.944 15.4386 1 14.5737 1H7.85707C7.48186 1 7.13531 1.19159 6.94855 1.50227L1.86587 9.95766C1.46512 10.6243 1.96924 11.4554 2.77438 11.4554H6.20299L2.97289 19.5203C2.50643 20.5406 3.76791 21.473 4.61626 20.735L17.7253 8.33119H10.8764L15.4095 2.60279Z"
                    className="thunder"
                    strokeWidth="1.5"
                    strokeLinecap="round"
