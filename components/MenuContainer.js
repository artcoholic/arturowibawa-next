      ...
      {open && (
        ...
        >
          ...
          <Grid gridRowGap={[12, null, 24]} gridTemplateColumns="1fr" width={['100%', null, 'auto']} justifyItems={['center', null, 'start']}>
            <MenuItem key="1" path="/" setOpen={setOpen} title="Project Gallery">
              Work
            </MenuItem>
            <MenuItem key="2" path="/blog" setOpen={setOpen} title="Blog Collection">
              Thoughts
            </MenuItem>
            <MenuItem key="3" path="/profile" setOpen={setOpen} title="About Me">
              Profile
            </MenuItem>
          </Grid>
          <Grid
