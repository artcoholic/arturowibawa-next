...
const IconWrapper = styled(Box)`
  ...
  span {
    ...
    svg {
      stroke: ${props => props.theme.colors.content.inversePrimary};
      display: block;
    }
    #eye-lid {
    ...
    #eye-lashes {
      animation: ${eyeLashes} 1500ms infinite alternate-reverse;
    }
  }
`
          ...
          <IconWrapper className="icon-wrapper">
            <span>
              <svg width={24} height={24} viewBox="0 0 24 24" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <g id="eye-lashes">
                  <path d="M12 16V19" />
                  <path d="M19 14L21 16.5" />
                  <path d="M16 15.5L17 18.5" />
                  <path d="M7 18.5L8 15.5" />
                  <path d="M5 14L3 16.5" />
                </g>
              </svg>
            </span>
