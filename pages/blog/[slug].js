...
const MarkdownWrapper = styled(Text)`
  ...
  blockquote {
    background-color: ${props => props.theme.colors.bg.placeholder};
    border-left: 1px solid ${props => props.theme.colors.content.inverseSecondary};
    margin: 0;
    padding: 1.25em;
    p:first-child {
      margin-bottom: 0;
