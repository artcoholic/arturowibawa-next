...
import Zapped from "../../components/Zapped";
...
const MarkdownWrapper = styled(Box, {
  ...
  pre: {
    backgroundColor: "$bg_placeholder",
    code: {
      background: "none",
    },
  },
  blockquote: {
    backgroundColor: "$bg_placeholder",
    borderLeft: "1px solid $fg_inverseSecondary",
    margin: 0,
    padding: "1.25em",
    "p:first-child": {
      marginBottom: 0,
  ...
  return (
    <>
      ...
      <CloseButton
        ...
        path={preview ? "/api/exit-preview" : "/blog"}
      />
      <Grid
        as={motion.section}
        initial="initial"
      ...
      >
        ...
        <Box
          ...
          css={{
            ...
            mb: "$0_5",
            "@bp1": { mt: "$0_5" },
            "@bp3": { gridColumn: "3/span 8" },
          }}
        />
        <MarkdownWrapper as={motion.article} variants={variants.ProfileContent}>
          <Markdown children={article.content} linkTarget="_blank" />
        </MarkdownWrapper>
        <Box
          as={motion.div}
          initial={{ scaleX: 0 }}
